...
-- Дамп данных таблицы things.action_type: ~3 rows (приблизительно)
...
INSERT INTO `action_type` (`action_type_id`, `action_type_name`, `icon_code`, `action_type_code`) VALUES
	...
	(3, 'Неизвестное устройство', 'QUESTION', 'UNKNOWN');
/*!40000 ALTER TABLE `action_type` ENABLE KEYS */;


-- Дамп структуры для процедура things.addNewUserFromSite
DELIMITER //
CREATE DEFINER=`kalistrat`@`localhost` PROCEDURE `addNewUserFromSite`(IN `eLog` VARCHAR(50), IN `ePassSha` VARCHAR(150), IN `eMail` VARCHAR(150), IN `ePhone` VARCHAR(50))
BEGIN
...
concat('ssl://0.0.0.0:',i_server_port+1)
,i_server_port+1
,0
,'LOCALHOST'
,'ssl'
,concat('ssl://snslog.ru:',i_server_port+1)
,i_user_id
);
...
INSERT INTO `environment_args` (`arg_id`, `arg_code`, `arg_value`) VALUES
	(1, 'OVERALL_WSE_LOCATION', 'http://localhost:8777/overallWse/Register?wsdl'),
...
INSERT INTO `mqtt_servers` (`server_id`, `server_ip`, `server_port`, `is_busy`, `name`, `server_type`, `vserver_ip`, `user_id`) VALUES
	...
	(11, 'ssl://0.0.0.0:9007', 9007, 0, 'LOCALHOST', 'ssl', 'ssl://snslog.ru:9007', 7);
...
INSERT INTO `user_devices_tree` (`user_devices_tree_id`, `leaf_id`, `parent_leaf_id`, `user_device_id`, `leaf_name`, `user_id`, `timezone_id`, `mqtt_server_id`, `time_topic`, `sync_interval`, `control_log`, `control_pass`, `control_pass_sha`) VALUES
	(1, 1, NULL, NULL, 'Устройства', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(2, 1, NULL, NULL, 'Устройства', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(3, 1, NULL, NULL, 'Устройства', 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(5, 1, NULL, NULL, 'Устройства', 7, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
